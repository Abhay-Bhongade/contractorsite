...
const HomePage = () => {
  const goggleUrl = `${process.env.REACT_APP_API_URL}users/google`;
  console.log("goggleUrl", goggleUrl);
  const facebookUrl = `${process.env.REACT_APP_API_URL_FACEBOOK}users/facebook/callback`;
  ...
  useEffect(() => {
    ...
    if (data) {
      ...
      // console.log("decrypted data in homepage", decryptedResponse);
    }
  }, [location.search]);

  return (
    <div className="container-fluid containerbginhomepage">
      <div className="row">
        <div className="col-3 pt-3 ps-3 pe-5 bg-white">
            ...
            <div className="content">
              ...
              <div className="slider-btn-brown btn-hover mt-4">
                <h1 className="animated">
                  ...
                  marketplace for all Construction things.
                </h1>
              </div>
              <div className="btncntinhomepage">
                ...
                {/* <div className="signupwithemailcnt mt-4">
                  <a
                    className="signupwithemail text-white"
