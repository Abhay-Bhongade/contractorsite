...
// import "../Navigation-view-product/Navigation-view-product.css";
import "../Navigation-view-product/Navigation-view-product.css";
import { Link } from "react-router-dom";

const NavigationViewProduct = () => {
            ...
            <li className="nav-item dropdown mx-4">
              ...
              <div className="dropdown-menu" aria-labelledby="navbarDropdown">
                <div className="dropdown dropend">
                  ...
                  <div
                    className="dropdown-menu dropdown-menu-end xyz"
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="d-flex ms-auto pe-5 navbar-nav">
              ...
              <li className="nav-item dropdown mx-4">
                ...
                <div className="dropdown-menu" aria-labelledby="navbarDropdown">
                  <Link to="/create-listing" className="dropdown-item" href="#">
                    List Product
                  </Link>
                  <a className="dropdown-item" href="#">
                    Vendor Dashboard
...
export default NavigationViewProduct;
