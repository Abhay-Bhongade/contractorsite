...
export const register = createAsyncThunk(
  ...
  async (user, thunkAPI) => {
    try {
      ...
      return await authService.register({ data: encryptedUser });
    } catch (error) {
      const message =
        (error.response &&
          error.response.data &&
...
export const login = createAsyncThunk("auth/login", async (user, thunkAPI) => {
  try {
    ...
    const encryptedUser = encrypt(user);
    return await authService.login({ data: encryptedUser });
  } catch (error) {
    const message =
...
//       const encryptedUser = encrypt(user);
//       console.log("encryptedUser", encryptedUser);
//       // Send the encrypted user data to the backend
//       const response = await authService.register(encryptedUser);

//       // Decrypt the response data from the backend
//       const decryptedResponse = decrypt(response.data,response.message);
