...
export const submitVerificationCode = createAsyncThunk(
  "user/submitVerificationCodedata",
  async (submitVerificationCodedata) => {
    console.log("userslice", submitVerificationCodedata);
    ...
    const response = await axios.post(
      process.env.REACT_APP_API_URL + "users/2faEmail",
      { data: encryptedUser },
      config
    );
...
export const resendVerificationCode = createAsyncThunk(
  ...
  async (resendVerificationCode) => {
    console.log("userslice", resendVerificationCode);
